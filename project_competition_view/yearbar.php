...
$query = "SELECT Class,count(*) as num1 FROM student s inner join project_competition sp WHERE s.ID=sp.ID and Year='$year' group by Class";
 ...
 <html lang="en">
  <head>
    <title>Project Competition Activities</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
 ...
 <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    ...
    var options = {
      title: 'Class wise Project Competition participation',
