...
$query = "SELECT Class,count(*) as num1 FROM student s inner join internship sp WHERE s.ID=sp.ID and Year='$year' group by Class";
 ...
 <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    ...
    var options = {
      title: 'Class wise Internship participation',
