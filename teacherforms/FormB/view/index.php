...
$_SESSION['flag']=0;
	if(($_SESSION['login_flag'] == 3) || ($_SESSION['login_flag'] == 2 &&  $_SESSION['Desg'] == 'Principal')){
		$sql = 'SELECT b.*,at.Full_Name FROM formb b INNER JOIN Authority at ON b.ID = at.ID';
		$print ='FormB:- All Teachers';
	}
	else if($_SESSION['login_flag'] == 2 && ($_SESSION['Desg'] == 'HOD' || isset($_SESSION['CH']))){
		$sql = "SELECT b.*,at.Full_Name FROM formb b INNER JOIN Authority at ON b.ID = at.ID WHERE at.Department ='$dept'";
		$print ='FormB:- '.$dept.' Department';
	}
