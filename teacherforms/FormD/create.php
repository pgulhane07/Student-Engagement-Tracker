  ...
  <div class="card mt-5">
    ...
    <div class="card-body">
      ...
      <form method="post" action="file_entry.php">
        ...
        <div class="form-group">
          <label for="DE">Duration of MoU</label>
          <input type="number" name="yrs" id="yrs" placeholder="Years">
        ...
        <div class="form-group">
          <button type="submit" onclick="myFunction()" class="btn btn-info">Upload Document Proof</button>
        </div>
      </form>
    </div>
  </div>
...
<script>
function myFunction() {
  document.getElementById("yrs").defaultValue = "0";
  document.getElementById("months").defaultValue = "0";
  document.getElementById("days").defaultValue = "0";
}
</script>
