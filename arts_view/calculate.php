...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'Arts:- All Students';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag']=$flag;
  if($flag == 1){
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Spt" style="display: none;">
              <input name="name" type="text" placeholder="Enter Arts Name" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
      ...
      <table class="table table-bordered">
       <thead>
        <tr style="font-size: 14.3px;">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Art_Type">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Arts Name<i class="fas fa-sort<?php echo $column == 'Art_Type' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Date_Arts">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Date of Occasion<i class="fas fa-sort<?php echo $column == 'Date_Arts' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>Certificate</th>
        </tr>
