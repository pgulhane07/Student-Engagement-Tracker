...
if ( isset($_POST['ID']) && isset($_POST['Cls']) && isset($_POST['Roll']) && isset($_POST['Department']) ) {
  ...
  $sql = 'UPDATE authority SET Class=:cls,Designation=:roll,Department=:depart WHERE ID=:id';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':cls' => $cls,':roll' => $roll,':depart' => $depart,':id' => $id])) {
          ...
          <div class="container">
                    ...
                    <div class="row">
                         ...
                         <form method="post">
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <label class="ele2" for="Roll">Designation</label>
                                   </div>
                                   <div class="col-md-6">
                                        <input value="<?= $person->Designation; ?>" type="text" name="Roll" class="input-field">
                                   </div>
                              </div>
                              <div class="row">
                                   <div class="col-md-6">
